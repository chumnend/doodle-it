    ...
    <div className="Editor">
      ...
      <section className={showMenu ? 'Editor-menu show' : 'Editor-menu hide'}>
        <header className="Editor-menu__header">
          <button className="Editor-menu__close-button" onClick={closeMenu}>
      ...
      <section className="Editor-workspace">
        <canvas className="Editor-workspace__canvas" ref={cRef}>
          Not Supported by browser.
        </canvas>
      </section>
      {isLoading && (
        <Modal className="Editor-modal__loader" show={true} close={() => {}}>
